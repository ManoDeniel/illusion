...
import br.com.illusion.domain.dto.ClientUpdateDTO;
...
public class ClientController {
  ...
  @PutMapping("/clients")
  @ApiOperation(
      value = "Update a client by id and DTO",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public String update(
      @RequestBody final ClientUpdateDTO clienteDTO) {
    final Client clienteInput = modelMapper.map(clienteDTO, Client.class);
  ...
  public String delete(@PathVariable(name = "clientId") final Long clientId) {
    final Client clientInput = Client.builder().id(clientId).build();
    return facade.delete(clientInput);
  }
}
